...
### Modelo Utilizado
Utilize o [Modelo Impresso em 3D](http://hyperurl.co/StlAtual) [Modelo Corte a Laiser](https://github.com/brothers-in-arms/Impressao-3D/tree/master/Corte%20a%20laiser) mais novo aqui no Repositório do Git. Os modelos do Repositório já passaram por processo de validação por profissionais da saúde. Conforme novas versões forem aprovadas, os arquivos do respositório serão atualizados.
